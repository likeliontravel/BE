...
public class GcsUploader {
    ...
    public GcsUploader() throws IOException {
        this.storage = StorageOptions.newBuilder().setCredentials(GoogleCredentials.fromStream(new FileInputStream("/Users/yeboong99/Desktop/toleave_back/src/main/resources/toleave-b9a7b3a17267.json"))).build().getService();
    }
