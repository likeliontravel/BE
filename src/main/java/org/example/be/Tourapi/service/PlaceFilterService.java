package org.example.be.Tourapi.service;


import lombok.RequiredArgsConstructor;

import org.example.be.Tourapi.dto.AccommodationResponseDTO;
import org.example.be.Tourapi.entity.Accommodation;
import org.example.be.Tourapi.region.TourRegion;
import org.example.be.Tourapi.region.TourRegionRepository;
import org.example.be.Tourapi.repository.AccommodationRepository;
import org.example.be.Tourapi.repository.TouristSpotRepository;
import org.example.be.Tourapi.theme.PlaceCategory;
import org.example.be.Tourapi.theme.PlaceCategoryRepository;
