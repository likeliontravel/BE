...
public class GlobalExceptionHandler {
	...
	// @ResponseBody
	// public ResponseEntity<CommonResponse<Void>> handleForbiddenResourceAccessException(
	...
	// @ResponseBody
	// public ResponseEntity<CommonResponse<Void>> handleUserAuthenticationNotFoundException(
	// 	UserAuthenticationNotFoundException e) {
	...
	// @ResponseBody
	// public ResponseEntity<CommonResponse<Void>> handleSecurityAuthenticationException(
	// 	SecurityAuthenticationException e) {
	...
	// 	} else if (ex instanceof MethodArgumentNotValidException validEx && !validEx.getBindingResult()
	// 		.getAllErrors()
	// 		.isEmpty()) {
