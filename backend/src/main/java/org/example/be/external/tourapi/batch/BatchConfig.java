package org.example.be.external.tourapi.batch;
...
import org.example.be.external.tourapi.batch.processor.TouristSpotItemProcessor;
import org.example.be.external.tourapi.batch.reader.TourApiItemReader;
import org.example.be.external.tourapi.batch.writer.AccommodationItemWriter;
import org.example.be.external.tourapi.batch.writer.RestaurantItemWriter;
import org.example.be.external.tourapi.batch.writer.TouristSpotItemWriter;
import org.example.be.external.tourapi.dto.FetchResult;
import org.example.be.external.tourapi.service.RefreshCategoryService;
import org.example.be.external.tourapi.service.RefreshRegionService;
