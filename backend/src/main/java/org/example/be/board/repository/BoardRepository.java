...
public interface BoardRepository extends JpaRepository<Board, Long> {
	...
	List<Board> findByTitleContainingOrContentContainingOrWriterContainingOrderByBoardHitsDesc(String title,
		String content, String writer, Pageable pageable);

	// 키워드 검색 시 최신순 정렬 - 내림차순
	List<Board> findByTitleContainingOrContentContainingOrWriterContainingOrderByUpdatedTimeDesc(String title,
		String content, String writer, Pageable pageable);
