...
public class UnifiedUserController {
	...
	public ResponseEntity<CommonResponse<UnifiedUsersNameAndProfileImageUrl>> getNameAndProfileImageUrl(
		@PathVariable String userIdentifier) {
		UnifiedUsersNameAndProfileImageUrl nameAndProfileImageUrl = unifiedUserService.getNameAndProfileImageUrlByUserIdentifier(
			userIdentifier);
		return ResponseEntity.status(HttpStatus.OK)
			.body(CommonResponse.success(nameAndProfileImageUrl, "이름과 프로필 사진 가져오기 성공"));
	}
