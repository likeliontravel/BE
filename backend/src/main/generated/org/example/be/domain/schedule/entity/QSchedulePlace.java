...
public class QSchedulePlace extends EntityPathBase<SchedulePlace> {
    ...
    private static final long serialVersionUID = -89390001L;
    ...
    public final EnumPath<org.example.be.domain.place.shared.type.PlaceType> placeType = createEnum("placeType", org.example.be.domain.place.shared.type.PlaceType.class);
