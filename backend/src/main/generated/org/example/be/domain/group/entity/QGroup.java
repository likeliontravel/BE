...
public class QGroup extends EntityPathBase<Group> {
    ...
    private static final long serialVersionUID = -1712581136L;
    ...
    public QGroup(Class<? extends Group> type, PathMetadata metadata, PathInits inits) {
        ...
        this.createdBy = inits.isInitialized("createdBy") ? new org.example.be.domain.member.entity.QMember(forProperty("createdBy")) : null;
    }
