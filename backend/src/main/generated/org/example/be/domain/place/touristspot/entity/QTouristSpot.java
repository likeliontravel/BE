...
public class QTouristSpot extends EntityPathBase<TouristSpot> {
    ...
    private static final long serialVersionUID = -1821353609L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QTouristSpot touristSpot = new QTouristSpot("touristSpot");

    public final org.example.be.domain.place.shared.entity.QPlace _super = new org.example.be.domain.place.shared.entity.QPlace(this);
    ...
    public final org.example.be.domain.place.theme.QPlaceCategory placeCategory;
    ...
    public final org.example.be.domain.place.region.QTourRegion tourRegion;
    ...
    public QTouristSpot(Class<? extends TouristSpot> type, PathMetadata metadata, PathInits inits) {
        ...
        this.placeCategory = inits.isInitialized("placeCategory") ? new org.example.be.domain.place.theme.QPlaceCategory(forProperty("placeCategory")) : null;
        this.tourRegion = inits.isInitialized("tourRegion") ? new org.example.be.domain.place.region.QTourRegion(forProperty("tourRegion")) : null;
    }
